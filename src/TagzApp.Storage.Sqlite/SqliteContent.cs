...
internal class SqliteContent
{
	...
	public SqliteModerationAction? ModerationAction { get; internal set; }

	public static explicit operator Content(SqliteContent thisContent)
	{
	...
	public static explicit operator SqliteContent(Content content)
	{

		return new SqliteContent
		{
