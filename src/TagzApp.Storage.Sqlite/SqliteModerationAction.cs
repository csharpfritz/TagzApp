...
internal class SqliteModerationAction
{
	...
	public static explicit operator SqliteModerationAction(ModerationAction action)
	{

		return new SqliteModerationAction
		{
			Id = action.Id,
	...
	public static explicit operator ModerationAction(SqliteModerationAction action)
	{
